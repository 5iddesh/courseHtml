let options = document.querySelectorAll(".myc-sort-option");
...
function handleSortClick(e){
    let targetEl = e;
    if(!targetEl.classList.contains("myc-sort-click")){
        targetEl = targetEl.closest(".myc-sort-click");
    }
    if(targetEl.nextElementSibling.style.display != "block"){
        let sort = document.querySelectorAll(".myc-sort-options");
        ...
        const courses = document.querySelectorAll(".myc-course");
        console.log(courses)
